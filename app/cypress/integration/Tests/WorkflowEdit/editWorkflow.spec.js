describe("testing the edit workflow functionality", () => {
  ...
  it("Navigate to the edit document page preform edits", () => {
    ...
    cy.get('[sizexs="9"] > .item-interactive > .ng-pristine > .native-input').clear().type("brenton.stroberg@yahoo.co.za",{force:true}).should("have.value", "brenton.stroberg@yahoo.co.za");
