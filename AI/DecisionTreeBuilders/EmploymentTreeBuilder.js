...
const outputFileName = './EmploymentDecisionTree.json';
...
const features = ['Length', 'ConsecutiveUnderscores', 'NumberSemicolons', 'SignKeyword','SignatureKeyword', "Employee", "Employer",
