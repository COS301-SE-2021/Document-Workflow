...
const outputFileName = './LeaseDecisionTree.json';
...
const features = ['Length', 'ConsecutiveUnderscores', 'NumberSemicolons', 'SignKeyword','SignatureKeyword', 'Landlord','Tenant',
				'DateKeyword','NameKeyword', 'WitnessKeyword', 'ByKeyword', 'AddressKeyword'];  
